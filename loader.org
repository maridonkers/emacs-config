...
(global-set-key (kbd "C-x r p l") (lambda () (interactive) (bookmark-load (expand-file-name "bookmarks" command-line-default-directory))))
(global-set-key (kbd "C-x r p s") (lambda () (interactive) (bookmark-write-file (expand-file-name "bookmarks" command-line-default-directory))))
#+END_SRC
**** Bookmarks (bm)
