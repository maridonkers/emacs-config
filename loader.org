...
(global-set-key (kbd "C-<Scroll_Lock>") #'systemctl-suspend)
...
#+END_SRC
* TODO exwm
Move this into a separate Emacs configuration and start it via =HOME=pathtoseparateemacsd emacs &= to separate from regular Emacs.
** Emacs Window Manager
Replace EXAMPLE with SRC emacs-lisp to enable =exwm= (which is very nice indeed, but I'm afraid
it'll give me carpal tunnel syndrome; sticking to KDE + tiling shortcuts).
