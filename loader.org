...
(use-package haskell-mode
    :pin melpa-stable
    :ensure t
    :config (setq haskell-process-suggest-restart nil)
    :bind ("M-<return>" . haskell-hoogle)
...
*** TODO Dante
Investigate [[https://github.com/haskell/ghcide][ghcide]] Emacs support.
[[https://github.com/jyp/dante][Dante]] is a fork of Intero mode which aims exclusively at providing a
convenient frontend to GHCi. It steals good ideas from Intero, but it
aims for light weightedness (see below for a detailed comparison).
#+BEGIN_SRC emacs-lisp
  ;; (use-package dante
  ;;   :ensure t
  ;;   :after haskell-mode
  ...
  ;;   ;; OR:
  ;;   ;; UNUSED -- (add-hook 'haskell-mode-hook 'flymake-mode)
  ;;         (add-hook 'haskell-mode-hook 'dante-mode)
  ;;   :config (flycheck-add-next-checker 'haskell-dante '(info . haskell-hlint))
  ;; )
...
#+END_SRC
*** TODO Attrap!
[[https://github.com/jyp/attrap#attrap-emacs-mode-to-fix-the-flycheck-error-at-point][Attrap!]] provides a command to attempt to fix the flycheck error at point.
#+BEGIN_SRC emacs-lisp
  ;; (use-package attrap
  ;;   :ensure t
...
*** TODO lsp-mode
First install =haskell-language-server=; under NixOS using the following command:

#+BEGIN_SRC shell
nix-env -f "<nixos-unstable>" -iA haskellPackages.haskell-language-server
#+END_SRC

See [[https://emacs-lsp.github.io/lsp-mode/page/installation/][LSP Mode - LSP support for Emacs]] and [[https://github.com/haskell/haskell-language-server][haskell-language-server]] and [[https://github.com/korayal/hls-nix][korayal/hls-nix]].
#+BEGIN_SRC emacs-lisp
