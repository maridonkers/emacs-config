...
(use-package exwm
  ...
  :config
    ...
    (exwm-input-set-key (kbd "C-c x") #'exwm-reset)
    (exwm-input-set-key (kbd "C-c k") #'exwm-workspace-delete)
    (exwm-input-set-key (kbd "C-c w") #'exwm-workspace-swap)
    (exwm-input-set-key (kbd "C-c s") #'exwm-workspace-switch)
    (exwm-input-set-key (kbd "C-c b") #'exwm-workspace-switch-to-buffer)
    (exwm-input-set-key (kbd "C-c m") #'exwm-workspace-move-window)
