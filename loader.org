...
** Configuration
*** gc-cons-threshold
To solve lsp-mode slowness after e.g. find definition.
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** lsp-mode
See: [[https://emacs-lsp.github.io/lsp-mode/tutorials/how-to-turn-off][A guide on disabling/enabling lsp-mode features]]
#+BEGIN_SRC emacs-lisp
