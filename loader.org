...
#+END_SRC
** TODO format-all
The =format-all= code formatter package a.o. supports brittany (for Haskell).
 [[https://github.com/lassik/emacs-format-all-the-code][lassik/emacs-format-all-the-code]] 
#+BEGIN_EXAMPLE
  ;; (use-package lanuage-id
  ;;   :pin melpa-stable
  ;;   :ensure t
  ;; )
  ;; (use-
...
#+END_SRC
*** Dante + Attrap
See [[https://github.com/jyp/dante#installation][jyp/dante]] and [[https://github.com/jyp/attrap][jyp/attrap]].
#+BEGIN_SRC emacs-lisp
  (defun dante-info-follow-window ()
    (interactive)
    (dante-info)
    (other-window 1))
